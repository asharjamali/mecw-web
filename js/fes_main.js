function getInputValue() {
                              ...
                              if (inputVal == 1) {
                                                            document.getElementById("demo").innerHTML = "Ashhar jamali";
                                                            ...
                                                            document.getElementById("demo").innerHTML = "Alkama salaar";
                                                            document.getElementById("demo1").innerHTML = "10000";
                              }

                              else if (inputVal == 4) {
                                                            document.getElementById("demo").innerHTML = "Furquan Ahmad";
                                                            document.getElementById("demo1").innerHTML = "10000";
                              }
                              else if (inputVal == 5) {
                                                            document.getElementById("demo").innerHTML = "Shahjad khan";
                                                            document.getElementById("demo1").innerHTML = "10000";
                              }
                              else if (inputVal == 6) {
